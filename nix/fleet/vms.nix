    ...
    ownloom = {
      ...
      microvm = {
        ...
        shares = [
          ...
          {
            tag = "ownloom-state";
            source = "/persist/microvms/ownloom/state";
            mountPoint = "/var/lib/ownloom";
            proto = "virtiofs";
          }
          {
            tag = "ownloom-web-state";
            source = "/persist/microvms/ownloom/web-state";
      ...
      ownloom = {
        ...
        personalWikiRoot = "/home/alex/wiki";
        technicalWikiRoot = "/var/lib/ownloom/wiki";
        personalWikiBackend = "webdav";
        technicalWikiBackend = "local";
        personalWikiWebdavUrl = "http://10.10.10.41/files/wiki/ownloom/";
        personalWikiWebdavUsername = "ownloom";
        personalWikiWebdavPasswordFile = "/var/lib/ownloom/secrets/ownloom-dav-password";
        wikiDefaultDomain = "personal";
