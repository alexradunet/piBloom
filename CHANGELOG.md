...
- Started the design-system migration with production `ds-button` and `ds-avatar` web components for static controls across the topbar, sidebars, status banner, modals, chat toolbar, and telemetry tabs.
