...
export async function handleSystemHealth(signal: AbortSignal | undefined): Promise<ActionResult<SystemHealthDetails>> {
	...
	return ok({ text: truncate(text), details: { sections } });
}
