...
import { defaultObjectBody, mergeObjectState, readMemoryRecord, writeMemoryRecord } from "../bloom-objects/memory.js";
...
export function ensureEpisodesDir(): string {
	const dir = path.join(getBloomDir(), "Episodes");
...
export function promoteEpisode(params: {
	...
	const objectsDir = path.join(getBloomDir(), "Objects");
