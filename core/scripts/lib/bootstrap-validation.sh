...
5. Before logging out after that rebuild:
   - open a second terminal and test SSH as the primary user
   - verify sshd -T and the nftables SSH rule
   - keep the recovery passwords for OVH KVM/rescue fallback
EOF_MANUAL
}
